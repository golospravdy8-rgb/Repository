...
export const metadata: Metadata = { title: "Новини — ЛДБЛ", description: "Новини Львівської Дитячої Баскетбольної Ліги" };
    ...
    <html lang="uk">
      ...
      <header style={{ backgroundColor: "#1e2a4a", color: "white", padding: "0 24px", height: "56px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 8px rgba(0,0,0,0.2)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <span style={{ fontWeight: 800, fontSize: "16px" }}>📰 Новини</span>
        </div>
        <div style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)" }}>Новини ЛДБЛ</div>
      </header>
