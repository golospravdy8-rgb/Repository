...
const DEFAULT_COLORS: Record<string, string> = {
  ...
  "colors.heroBg":          "#f1f5f9",
  "colors.heroTitle":       "#f97316",
  "colors.heroSubtitle":    "#64748b",
  ...
  // === КНОПКИ ===
  "colors.btnBlue":         "#3b82f6",
  "colors.btnOrange":       "#f97316",
  "colors.btnNavy":         "#1a2744",
  "colors.btnRed":          "#ef4444",
  "colors.btnSchedule":     "#3b82f6",
  "colors.btnHero":         "#f97316",
  "colors.btnDonate":       "#f97316",
